...
Normalerweise leben wir im Autopiloten, in der sogenannten \textbf{\enquote{natürlichen Einstellung}}. Wir glauben naiv, dass die Welt da draußen einfach existiert und unser Kopf sie wie eine Kamera abfotografiert. Wir schauen auf den Baum oder genießen unseren Kaffee, aber wir vergessen dabei das \textit{Schauen} selbst. Wir sind wie Kinobesucher, die sich so sehr im Film verlieren, dass sie die Leinwand und den Projektor vergessen.
...
Husserl nennt das die \textbf{Intentionalität}.
Seine bahnbrechende Erkenntnis lautet: \textit{\enquote{Bewusstsein ist immer Bewusstsein \textbf{von} etwas.}}
Das Bewusstsein ist kein Ort, an dem Dinge aufbewahrt werden. Es ist eine reine Aktivität, die auf Dinge \textit{zielt}.
Es gibt kein \enquote{Denken} an sich, sondern nur das Denken \textit{an die Mathematik}. Es gibt keine \enquote{Liebe} in einer Herz-Schachtel, sondern nur die Liebe \textit{zu einer Person}.
Das Bewusstsein ist also keine Kiste, sondern eine **Explosion**. Es explodiert ständig aus sich heraus hin zur Welt. Sartre formulierte es später poetisch: Das Bewusstsein ist ein transparenter Wind, der durch uns hindurchweht zu den Dingen. Es ist leer. Und genau deshalb sind wir unmittelbar \textit{in der Welt} und nicht in unserem Kopf gefangen.
