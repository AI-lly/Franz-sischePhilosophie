...
In Sartres Stück \textit{Geschlossene Gesellschaft} sagt Garcin: \textit{\enquote{L'enfer, c'est les autres.}}
Das bedeutet nicht, dass andere Menschen nerven oder dass wir Misanthropen sein sollten.
Es ist eine ontologische Aussage über den **Blick** (Le Regard).

Um das zu verstehen, nutzen wir Sartres Beispiel des **Spanners am Schlüsselloch**:
...
Der Andere stiehlt ihm seine Welt. Die Dinge im Flur ordnen sich nicht mehr um den Spanner, sondern um den Neuankömmling.
...
Das Gefühl, das diesen Wandel begleitet, ist **Scham**.
