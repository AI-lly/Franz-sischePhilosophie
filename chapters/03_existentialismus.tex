...
\begin{itemize}
    ...
    \item \textbf{Das Für-sich-Sein (Le pour-soi):} Das ist der Mensch (das Bewusstsein). Weil wir uns unserer selbst bewusst sind, haben wir Distanz zu uns selbst. Wir sind nie deckungsgleich mit uns wie der Stein. Wir können unsere Vergangenheit verneinen und unsere Zukunft entwerfen.
\end{itemize}
Sartres geniale Definition lautet: Der Mensch ist das Wesen, durch das das \textbf{Nichts} in die Welt kommt. Wir sind wie ein \enquote{Wurm im Apfel des Seins}. Wir höhlen das massive Sein aus, indem wir Fragen stellen, indem wir Dinge verneinen, indem wir uns Alternativen vorstellen.
